(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@system.fetch'), require('@system.request'), require('@system.storage'), require('@system.router'), require('@system.prompt'), require('@system.barcode'), require('@system.vibrator'), require('@system.clipboard'), require('@system.sensor'), require('@system.geolocation'), require('@system.share'), require('@system.notification'), require('@system.device'), require('@system.webview'), require('@system.audio'), require('@system.record'), require('@system.contact'), require('@system.sms')) :
  typeof define === 'function' && define.amd ? define(['exports', '@system.fetch', '@system.request', '@system.storage', '@system.router', '@system.prompt', '@system.barcode', '@system.vibrator', '@system.clipboard', '@system.sensor', '@system.geolocation', '@system.share', '@system.notification', '@system.device', '@system.webview', '@system.audio', '@system.record', '@system.contact', '@system.sms'], factory) :
  (factory((global.TaroAuickapp = {}),global.fetch,global.quickRequest,global.storage,global.router,global.prompt,global.barcode,global.vibrator,global.clipboard,global.sensor,global.geolocation,global.share,global.notification,global.device$1,global.webview,global.audio,global.record,global.contact,global.sms));
}(this, (function (exports,fetch,quickRequest,storage,router,prompt,barcode,vibrator,clipboard,sensor,geolocation,share,notification,device$1,webview,audio,record,contact,sms) { 'use strict';
