...
export default function initNativeApi(taro) {
    ...
    Object.assign(taro, request, storage, system, network, clipboard, phone, web, vibrate, accelerometer, deviceMotion, media, file, webSocket, location, toast, image, others);
}
