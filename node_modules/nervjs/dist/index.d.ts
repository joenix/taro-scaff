...
declare module 'nervjs' {
    ...
    import { useEffect, useLayoutEffect, useReducer, useState, useRef, useCallback, useMemo, useImperativeHandle, useContext } from 'nervjs/hooks';
...
declare module 'nervjs/lifecycle' {
    ...
    export function mountComponent(vnode: FullComponent, parentContext: object, parentComponent: any): Element;
